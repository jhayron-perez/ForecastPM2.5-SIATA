...
class TaylorDiagram(object):
    ...
    def __init__(self, refstd,
                 fig=None, rect=111, label='_', srange=(0, 1.5), extend=False, msref=10, zorderef=10):
        """
        ...
        * msref: size of the reference marker
        * zorderef: z order of the reference marker
        """
        ...
        l, = self.ax.plot([0], self.refstd, 'k*',
                          ls='', ms=msref, label=label, zorder=zorderef)
