...
for model_name in model_names:
    if model_name=='CAMS':
        ...
        forecasts[model_name] = forecasting.forecast_pm2p5_v2(forecast_initial_date,pm2p5,df_optimal_cams,\
            df_optimal_gfs,model_name=model_name,mos_correction=True)
