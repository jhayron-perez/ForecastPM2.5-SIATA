...
path_fig = '/var/data1/AQ_Forecast_DATA/results_oldv/figures/mean/archive/Fc_Mean_'+\
...
plt.xlim(dates_forecast[0]-dt.timedelta(hours=12),dates_forecast[-1])
plt.grid(ls='--',alpha=0.3)
path_fig = '/var/data1/AQ_Forecast_DATA/results_oldv/figures/mean/archive/Fc_AOD_'+\
    str(forecast_initial_date).replace(':','').replace(' ','_').replace('-','')+'.png'
# plt.show()
plt.savefig(path_fig,bbox_inches='tight')
os.system('cp '+path_fig+' '+path_fig.replace(str(forecast_initial_date).replace(':','').\
...
### Guardar tabla:
path_table = '/var/data1/AQ_Forecast_DATA/results_oldv/tables/mean/archive/Fc_AOD_'+\
...
files_forecasts = np.sort(glob.glob\
    ('/var/data1/AQ_Forecast_DATA/results_oldv/tables/mean/archive/*.csv'))
...
plt.grid(ls='--',alpha=0.3)
# plt.show()
path_fig = '/var/data1/AQ_Forecast_DATA/results_oldv/figures/mean/archive/Fc_Eval_'+\
    str(forecast_initial_date).replace(':','').replace(' ','_').replace('-','')+'.png'
plt.savefig(path_fig,bbox_inches='tight')
os.system('cp '+path_fig+' '+path_fig.replace(str(forecast_initial_date).replace(':','').\
                                              replace(' ','_').replace('-',''),'Current').replace('/archive',''))
...
t2 = ("* Este producto indica el pronóstico de la concentración de PM2.5 en promedios de 24 horas para\n"
      ...
      "incertidumbre asociada.\n\n")
text2 = plt.figtext(0.94, -0.25, t2,fontsize=11, wrap=True)
path_fig = '/var/data1/AQ_Forecast_DATA/results_oldv/figures/mean/archive/Fc_Mean24h_'+\
    str(forecast_initial_date).replace(':','').replace(' ','_').replace('-','')+'.png'
# plt.show()
plt.savefig(path_fig,bbox_inches='tight')
os.system('cp '+path_fig+' '+path_fig.replace(str(forecast_initial_date).replace(':','').\
...
local_path = '/var/data1/AQ_Forecast_DATA/results_oldv/'
sal_path = '/var/www/CalidadAire/Pronostico_PM25_OldV/'
...
#Copiar todo a SAL:
#os.system('scp -r /var/data1/AQ_Forecast_DATA/results_oldv/* calidadaire@siata.gov.co:/var/www/CalidadAire/Pronostico_PM25_OldV')


os.system('scp '+path_1+' calidadaire@siata.gov.co:'+path_1.replace(local_path,sal_path))
os.system('scp '+path_2+' calidadaire@siata.gov.co:'+path_2.replace(local_path,sal_path))
os.system('scp '+path_3+' calidadaire@siata.gov.co:'+path_3.replace(local_path,sal_path))
os.system('scp '+path_4+' calidadaire@siata.gov.co:'+path_4.replace(local_path,sal_path))
os.system('scp '+path_5+' calidadaire@siata.gov.co:'+path_5.replace(local_path,sal_path))
os.system('scp '+path_6+' calidadaire@siata.gov.co:'+path_6.replace(local_path,sal_path))
os.system('scp '+path_7+' calidadaire@siata.gov.co:'+path_7.replace(local_path,sal_path))
os.system('scp '+path_8+' calidadaire@siata.gov.co:'+path_8.replace(local_path,sal_path))
os.system('scp '+path_9+' calidadaire@siata.gov.co:'+path_9.replace(local_path,sal_path))
os.system('scp '+path_10+' calidadaire@siata.gov.co:'+path_10.replace(local_path,sal_path))
